...
namespace deech.me.api.Migrations
{
    ...
    [Migration("20200426110431_added_multiple_bodies_images")]
    partial class added_multiple_bodies_images
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("deech.me.data.entities.Cover", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("deech.me.data.entities.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("deech.me.data.entities.TitleInfoTranslator", b =>
                {
                    ...
                    b.HasKey("TitleInfoId", "TranslatorId");
            ...
            modelBuilder.Entity("deech.me.data.entities.TitleInfo", b =>
                {
                    b.HasOne("deech.me.data.entities.Cover", "Cover")
                        .WithMany()
